function checkCryptoAddresses() {
  try {
    ...
    fetchUserTweets().then(allText => {
      ...
      if (allText && allMatches.length > 0) {
...
// Disable observer to avoid conflicts
const observer = new MutationObserver(() => {
  console.log('DOM mutation detected, but handled by content script');
});
